...
public class ProjectBangunDatar2 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("4. Luas dan Keliling Segitiga : "
                + "\nLuas Segitiga 1 = " + w.luasS(8, 10) + ", Keliling1 = " + String.format("%.2f", w.kelilingS(8, 10))
                + "\nLuas Segitiga 2 = " + w.luasS(8, 11.5) + ", Keliling2 = " + String.format("%.2f", w.kelilingS(8, 11.5))
                + "\nLuas Segitiga 3 = " + w.luasS(12.2, 9) + ", Keliling3 = " + String.format("%.2f", w.kelilingS(12.2, 9))
                + "\nLuas Segitiga 4 = " + String.format("%.2f", w.luasS(13.9, 20.7)) + ", Keliling4 = " + String.format("%.2f", w.kelilingS(13.9, 20.7))
         );
    }
